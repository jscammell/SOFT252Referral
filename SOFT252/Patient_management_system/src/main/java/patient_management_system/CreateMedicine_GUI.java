 ...
 * @author Josh
 */
public class CreateMedicine_GUI extends javax.swing.JFrame {

    /**
     * Creates new form CreatePerscription_GUI
     */
    public CreateMedicine_GUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateMedicine_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateMedicine_GUI().setVisible(true);
            }
        });
    }
