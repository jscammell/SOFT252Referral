 ...
 * @author Josh
 */
public class ConfirmAppointment_GUI extends javax.swing.JFrame {

    /**
     * Creates new form AppointmentRequest
     */
    public ConfirmAppointment_GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmAppointment_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConfirmAppointment_GUI().setVisible(true);
            }
        });
    }
