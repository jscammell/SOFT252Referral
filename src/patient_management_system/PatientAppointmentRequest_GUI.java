 ...
 * @author Josh
 */
public class PatientAppointmentRequest_GUI extends javax.swing.JFrame {

    /**
     * Creates new form AppointmentRequest
     */
    public PatientAppointmentRequest_GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientAppointmentRequest_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientAppointmentRequest_GUI().setVisible(true);
            }
        });
    }
