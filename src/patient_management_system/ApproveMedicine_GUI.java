 ...
 * @author Josh
 */
public class ApproveMedicine_GUI extends javax.swing.JFrame {

    /**
     * Creates new form CreatePerscription_GUI
     */
    public ApproveMedicine_GUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApproveMedicine_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApproveMedicine_GUI().setVisible(true);
            }
        });
    }
