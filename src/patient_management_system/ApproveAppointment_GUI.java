 ...
 * @author Josh
 */
public class ApproveAppointment_GUI extends javax.swing.JFrame {

    /**
     * Creates new form AppointmentRequest
     */
    public ApproveAppointment_GUI() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApproveAppointment_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApproveAppointment_GUI().setVisible(true);
            }
        });
    }
