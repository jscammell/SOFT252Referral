...
public class SecretaryApproveRequestedAppointment_GUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SecretaryApproveRequestedAppointment_GUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SecretaryApproveRequestedAppointment_GUI().setVisible(true);
            }
        });
    }
